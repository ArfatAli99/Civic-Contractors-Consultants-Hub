...
module.exports = () => {
  ...
  global.eventEmitter.on('client_invitation_email', (userData) => {
    ...
    GenericRepository.fetchData(email_data).then(email_result=>{
      ...
      // emailBody = emailBody.replace(/\[civicContractorsandConsultantshub_logo\]/g,process.env.WEBURL+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.svg');
    // emailBody = emailBody.replace(/\[WEBSITE_LINK\]/g,process.env.WEBURL+'/civicContractorsandConsultantshub/html/');
      emailBody = emailBody.replace("[civicContractorsandConsultantshub_logo]",process.env.WEBURL+':'+process.env.SERVER_PORT+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png');
      ...
      emailBody = emailBody.replace("[WEBSITE_LINK]",process.env.WEBURL);
        ...
        return commonFunctions.sendMail('"civicContractorsandConsultantshub"<dnldfolder@unifiedinfotech.net>', userData.email, emailSubject, '', emailBody).then((info1) => {
  ...
  global.eventEmitter.on('invite_to_article_link', (userData) => {
    ...
    global.eventEmitter.on('ask_me_email',(user)=>{
      ...
      GenericRepository.fetchData(email_data).then(result=>{
        ...
        // body = body.replace(/\[civicContractorsandConsultantshub_logo\]/g,process.env.WEBURL+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.svg');
        // body = body.replace(/\[WEBSITE_LINK\]/g,process.env.WEBURL+'/civicContractorsandConsultantshub/html/');
        body = body.replace("[civicContractorsandConsultantshub_logo]",process.env.WEBURL+':'+process.env.SERVER_PORT+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png');
        ...
        return commonFunctions.sendMail('"civicContractorsandConsultantshub"<dnldfolder@unifiedinfotech.net>', user.email, subject, '',body).then((info1) => {
      ...
      global.eventEmitter.on('project_tender',(user)=>{
        ...
        GenericRepository.fetchData(email_data).then(result=>{
         ...
         // body = body.replace("[USERNAME]", user.name);
          ...
          body = body.replace("[WEBSITE_LINK]",process.env.WEBURL+'/civicContractorsandConsultantshub/html/');
  ...
  global.eventEmitter.on('project_sign_to_client',(user)=>{
    ...
    GenericRepository.fetchData(email_data).then(result=>{
      ...
      body = body.replace("[civicContractorsandConsultantshub_logo]",process.env.WEBURL+':'+process.env.SERVER_PORT+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png');
      body = body.replace("[WEBSITE_LINK]",process.env.WEBURL+'/civicContractorsandConsultantshub/html/');
      return commonFunctions.sendMailAttachment('"civicContractorsandConsultantshub"<dnldfolder@unifiedinfotech.net>', user.email, subject, '',body,attachments).then((info1) => {
  ...
  global.eventEmitter.on('contractor_profile_approved',(user)=>{
    ...
    GenericRepository.fetchData(email_data).then(result=>{
      ...
      var body=result.rows[0].dataValues.content;
      body = body.replace("[USERNAME]", user.username);
      body = body.replace("[civicContractorsandConsultantshub_logo]",process.env.APIURL+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png');
      body = body.replace("[WEBSITE_LINK]",process.env.WEBURL+'/civicContractorsandConsultantshub/html/');
...
// 
  ...
  //     body = body.replace("[civicContractorsandConsultantshub_logo]",process.env.WEBURL+':'+process.env.SERVER_PORT+'/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png');
  //     body = body.replace("[WEBSITE_LINK]",process.env.WEBURL+'/civicContractorsandConsultantshub/html/');
  //     return commonFunctions.sendMail('"civicContractorsandConsultantshub"<dnldfolder@unifiedinfotech.net>', user.email, subject, '',body,user.path).then((info1) => {
