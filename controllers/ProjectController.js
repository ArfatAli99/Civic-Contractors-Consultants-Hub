...
const CommonValidationMiddlewareHelper = require('../middlewares/CommonValidationMiddlewareHelper');
  ...
  (async () => {
    ...
    try {
     ...
     // console.log(contractor_details.rows[0].dataValues.project.user.full_name)
      ...
      email_data.link='https://civicContractorsandConsultantshub.com/login/client';
...
ProjectController.downloadProjectDrawingZip_example = function (req, res) {
  (async () => {
    try {
      ...
      zip.addLocalFile("/home/dnldfolder/Downloads/fish_water_swimming_135611_1366x768.jpg");
      zip.addLocalFile("/home/dnldfolder/Downloads/civicContractorsandConsultantshub-Logo-Colored.png");

      // or write everything to disk
      zip.writeZip(/*target file name*/"/home/dnldfolder/Documents/files.zip");
        ...
        GenericRepository.fetchData(get_project_doc_data).then(get_project_doc_result => {
          if (get_project_doc_result.rows.length > 0) {
            ...
            for (let i = 0; i < get_project_doc_result.rows.length; i++) {
              ...
              zip.addLocalFile("/var/www/html/civicContractorsandConsultantshub-node/uploads/" + get_project_doc_result.rows[i].dataValues.resource_url);
              if (i == get_project_doc_result.rows.length - 1) {
                ...
                zip.writeZip(/*target file name*/"/var/www/html/civicContractorsandConsultantshub-node/uploads/project_zips/" + get_zip_file_name_for_project_drawings + ".zip");
...
<div class="page">
	...
	<header class="page-header">
		<div class="site-logo">
			<img src="`+process.env.WEBURL+`:`+process.env.SERVER_PORT+`/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png" alt="civicContractorsandConsultantshub Logo Colored">
		</div>
	</header>
	<!-- page-header -->
	<!-- page-heading -->
...
//               <title>civicContractorsandConsultantshub</title>
//            </head>
...
//         }
//         html += `<tr>
//             <td class="text-center"><p class="copy-txt">© 2020 civicContractorsandConsultantshub. All Rights Reserved. </p></td>
//         </tr>
//         </table>
//         </div>
//         </body>`
...
order_data.push()
      ...
      var html = `<title>Project Scope</title>
        ...
        <div class="page">
          ...
          <header class="page-header">
            <div class="site-logo">
              <img src="`+process.env.WEBURL+`:`+process.env.SERVER_PORT+`/uploads/general_images/eb-logo.svg" alt="civicContractorsandConsultantshub Logo Colored">
            </div>
          </header>
          <!-- page-header -->
          <!-- table -->
...
let v=1;
      ...
      if(req.query.lang=='ara'){
        ...
        <style>
          ...
          @font-face{
            font-family:'Dubai';
            src:url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Regular.eot');
            src:url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Regular.eot?#iefix') format('embedded-opentype'),
                url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Regular.woff') format('woff'),
                url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Regular.ttf') format('truetype');
            font-weight:400;
            font-style:normal;
            font-display:swap;
          }
          @font-face{
            font-family:'Dubai';
            src:url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Bold.eot');
            src:url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Bold.eot?#iefix') format('embedded-opentype'),
                url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Bold.woff') format('woff'),
                url('http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/fonts/Dubai-Bold.ttf') format('truetype');
            font-weight:700;
            font-style:normal;
            font-display:swap;
          }
        ...
        <div class="page">
          ...
          <header class="page-header">
            <div class="site-logo">
              <img src="`+process.env.APIURL+`/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png" alt="civicContractorsandConsultantshub Logo Colored">
            </div>
          </header>
          <!-- page-header -->
          <!-- table -->
      ...
      let html = await new Promise(function (resolve, reject) {
        ...
        <html xmlns:v="urn:schemas-microsoft-com:vml">
           <head>
              ...
              <meta http-equiv="X-UA-Compatible" content="IE=edge">
              <meta content="width=device-width, initial-scale=1.0, shrink-to-fit=no, minimal-ui" name="viewport">
              <title><span style="color:rgb(50,49,48);">‘civicContractorsandConsultantshub’</span></title>
           </head>
...
if(req.query.lang=='ara')
{
  ...
  <style>
    ...
    *{
    ...
    .page.full-height-page{
      ...
      background:url(http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/images/Full-Page-Background.svg) center bottom repeat-x;
      background-size:1200px auto;
      background-color:#fff;
    }
    /* page-break */
  ...
  <div class="page">
    ...
    <h3>تمهيد:</h3>
		<p class="i-am-point"><strong class="number-system"> أ </strong> بما أن العميل والمقاول هما مستخدمين مسجلين لـدى بناء الإلكترونية <span style="color:rgb(50,49,48);">‘civicContractorsandConsultantshub’</span> (يشار إليها فيما يلي باسم "المنصة")، وهي مزود خدمة تقديم العطاءات إلكترونياً عبر الإنترنت وإدارة المشاريع أوتوماتيكيا</p>
        ...
        <tbody>
          <tr>
            <td class="text-right">
             ...
             html+= `<p>بتاريخ:${fetch_info.rows[0].dataValues.client_sign_date}<br>تم التوقيع عليها <strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`

              }
              else
              {

                html+= `<p>بتاريخ:<br>تم التوقيع عليها <strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`
           ...
           html+= `</td>
            <td class="text-left">
              ...
              html+=`<p>بتاريخ:${contract_date}<br>تم التوقيع عليها<strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`
              }
              else
              {
                html+=`<p>بتاريخ:<br>تم التوقيع عليها<strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`
  ...
  <div class="page full-height-page">
    ...
    <header class="page-header">
      <div class="site-logo">
        <img src="http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/images/civicContractorsandConsultantshub-Logo-Colored.svg"  alt="civicContractorsandConsultantshub Logo Colored">
      </div>
    </header>
    <!-- page-header -->
    <!-- page-heading -->
            ...
            <div class="user-image">
              <div class="holder">
                ...
                if(fetch_photo && fetch_photo.rows.length>0){
                 ...
                 html+=` <img src="http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/images/No-User-Image.jpg" alt="Image">`
                }
               html+=` </div>
                <div class="data">`
    ...
    var html= `<title>Contract English</title>
      ...
      <div class="page">
        ...
        <div class="cover-image">
          <!-- cover-image-pic -->
          <div class="cover-image-pic">
            <img src="`+process.env.WEBURL+`:`+process.env.SERVER_PORT+`/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png" alt="Cover Image Arabic">
          </div>
          <!-- cover-image-pic -->
          <!-- cover-image-data -->
          <div class="cover-image-data">
      ...
      <div class="page">
        ...
        <h3>RECITALS</h3>
        <p class="i-am-point"><strong class="number-system">A.</strong> WHEREAS the Client and the Contractor are registered users of <span style="color:rgb(50,49,48);">‘civicContractorsandConsultantshub’</span> (hereinafter the “Platform”), an online eTendering and automated project management service provider;</p>
            ...
            <tbody>
              <tr>
                <td class="text-left">
                 ...
                 html+= `<p>Dated:${fetch_info.rows[0].dataValues.client_sign_date}<br>Signed through <strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`

                  }
                  else
                  {

                    html+= `<p>Dated:<br>Signed through <strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`
               ...
               html+= `</td>
                <td class="text-right">
                  ...
                  html+=`<p>Dated:${contract_date}<br>Signed through <strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`
                  }
                  else
                  {
                    html+=`<p>Dated:<br>Signed through <strong class="blue">www.civicContractorsandConsultantshub.com</strong></p>`
      ...
      if(get_final_project_contracts_result.rows.length > 0){
        ...
        <div class="page">
          ...
          <footer class="page-footer">
            <p class="foot-note">Generated From www.civicContractorsandConsultantshub.com</p>
          </footer>
          <!-- page-footer -->
        </div>
        <!-- end of page 1 -->`
      ...
      if(req.query.lang=='ara'){
        ...
        * { 
        ...
        <div class="container">
            ...
            <table class="table1" width="100" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="text-center site-logo"><img src="`+global.constants.PDFIMAGEPATH+`/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png"  class="" alt="logo"></td>
                </tr>
                <tr>
                    <td>
                        <h1>نطاق المشروع</h1>
    ...
    <table class="table pdf-page-1" width="100" border="0" cellpadding="0" cellspacing="0">
          <tr>
              <td class="text-center site-logo">
                <img src="`+process.env.WEBURL+`:`+process.env.SERVER_PORT+`/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png" class="" alt="logo">
                  ...
                  <tr>
                      ...
                      if(company_logo_fetch.rows.length>0){
                       html+=` <img src="`+process.env.WEBURL+`:`+process.env.SERVER_PORT+`/uploads/`+company_logo_fetch.rows[0].dataValues.resource_url+`"  alt="">`
                        ...
                        html+=` <img src="http://dev.uiplonline.com/civicContractorsandConsultantshub/pdf-templates/stage-task-details/images/No-User-Image.jpg" alt="">`
...
<div class="page">
	<div class="container">
		...
		<table class="table pdf-page-1" width="100" border="0" cellpadding="0" cellspacing="0">
	        <tr>
	            <td class="text-center site-logo">
	            	<img src="`+global.constants.PDFIMAGEPATH+`/uploads/common_images/civicContractorsandConsultantshub-Logo-Colored.png" class="" alt="logo">
